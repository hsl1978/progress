<template>
  <ul class="mod-navs theme-spline-top">
    <li>
      <router-link class="navs-item-home" to="/home">首页</router-link>
    </li>
    <li>
      <router-link class="navs-item-menu" to="/list">列表页</router-link>
    </li>
    <li>
      <router-link class="navs-item-cart" to="/cart">购物车</router-link>
    </li>
    <li>
      <router-link class="navs-item-mine" to="/my">我的</router-link>
    </li>
  </ul>
</template>
  ...
  .mod-navs
    ...
    li
      ...
      .navs-item-home
        ...
        &.active
          background-image:url(../../assets/images/menu-icon/navs-item-home-active.png)
      .navs-item-menu
      ...
      .navs-item-mine
        ...
        &.active
          background-image:url(../../assets/images/menu-icon/navs-item-mine-active.png)
</style>
